...
<head>
    ...
    <link href="../public/assets/css/devextreme/dx.common.css" rel="stylesheet" />
    <link href="../public/assets/css/devextreme/dx.light.css" rel="stylesheet" />

    <script src="../public/assets/js/devextreme/jquery.js"></script>
    <script src="../public/assets/js/devextreme/dx.all.js"></script>
    <!-- STYLES -->
...
<header>
    ...
    <div class="panel-btnsearch" style="padding-top:10px;height:10%;text-align:center">
                <div class="btnsearch w-50"></div>
</header>
